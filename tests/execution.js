...
step("run all specifications", function () {
  _gauge.runSpecs(languageclient.projectPath());
});

step("the execution status of <directoryPath> should be <expectedDetails>", function(directoryPath,expectedDetails) {
